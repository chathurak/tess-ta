            ...
            <div>
                <div className={classes.root}>
                    <Paper className={classes.paper}>
                        ...
                        <FixedSizeList height={400} itemSize={46} itemCount={this.state.mainDictionary.size}>
                            {this.mainDictionaryWords}
                        </FixedSizeList>

                        <div className={classes.buttonBar}>
                            <IconButton aria-label="Delete" className={classes.margin} onClick={this.handleAdd}>
                                <AddIcon fontSize="large" />
                            </IconButton>
                            <IconButton aria-label="Delete" className={classes.margin} onClick={this.handleEdit}>
                                <Icon>edit_icon</Icon>
                            </IconButton>
