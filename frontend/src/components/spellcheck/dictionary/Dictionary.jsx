                        ...
                        <Grid item xs={6}>
                            <Paper style={{padding: 10}}>
                                <Grid container className={classes.root}>
                                    <Grid item xs={6}>
                                        <form>
                                            <TextField className={classes.inputTextArea} label={this.state.selectedWord}
                                                       variant="outlined" value={this.state.inputText}
                    ...
                    <Grid container className={classes.dictionaryPanel}>
                        ...
                        <Grid item xs={6}>
                            <Paper className={classes.paper}>
                                ...
                                <FixedSizeList className={classes.wordListView} height={400} itemSize={20}
                                               itemCount={this.state.dictionaryPrimary.size}>
                        ...
                        <Grid item xs={6}>
                            <Paper className={classes.paper}>
                                ...
                                <FixedSizeList className={classes.wordListView} height={400} itemSize={20}
                                               itemCount={this.state.dictionarySecondary.size}>
