                                ...
                                <Grid container className={classes.root}>
                                    ...
                                    <form>
                                        <TextField 
                                            ...
                                            onChange={e => this.setState({ inputRule: {key: e.target.value, value: this.state.inputRule.value} })}/>
                                        <TextField
                                            className={classes.inputTextArea}
                                            label={this.state.selectedRule.value} 
                                            variant="outlined"
                                            value={this.state.inputRule.value}
                                            onChange={e => this.setState({ inputRule: {key: this.state.inputRule.key, value: e.target.value} })}/>
                                    </form>
                                    </Grid>
                                    <Grid item xs={8}>
                    ...
                    <Grid container className={classes.rulesPanel}>
                        ...
                        <Grid item xs={6}>
                            <Paper className={classes.paper}>
                                ...
                                <FixedSizeList className={classes.ruleListView} height={400} itemSize={20} itemCount={this.state.mandatoryRules.size}>
                                    {this.mandatoryRules}
                                </FixedSizeList>
                            </Paper>
                        </Grid>
                        ...
                        <Grid item xs={6}>
                            <Paper className={classes.paper}>
                                ...
                                <FixedSizeList className={classes.ruleListView} height={400} itemSize={20} itemCount={this.state.optionalRules.size}>
                                    {this.optionalRules}
                                </FixedSizeList>
                            </Paper>
                        </Grid>
