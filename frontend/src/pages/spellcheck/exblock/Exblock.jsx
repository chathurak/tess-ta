                ...
                <div className={classes.root}>
                        ...
                        <Grid item xs={6}>
                            <Paper style={{padding: 10}}>
                                <Grid container className={classes.root}>
                                    <Grid item xs={6}>
                                    <form>
                                        <TextField className={classes.inputTextArea} label={this.state.selectedLetter} variant="outlined" value={this.state.inputText} onChange={e => this.setState({ inputText: e.target.value })}/>
                                    </form>
                                    </Grid>
                                    <Grid item xs={6}>
                    ...
                    <Grid container className={classes.exblockPanel}>
                        <Paper className={classes.paper}>
                            ...
                            <FixedSizeList className={classes.letterListView} height={400} itemSize={20} itemCount={this.state.exblockLetters.size}>
                                {this.exblockLetters}
                            </FixedSizeList>
                        </Paper>
                    </Grid>
